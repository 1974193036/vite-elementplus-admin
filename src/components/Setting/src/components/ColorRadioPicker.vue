...
const prefixCls = getPrefixCls('color-radio-picker') // v-color-radio-picker
...
//   () => props.modelValue,
//   (val: string) => {
//     console.log('11', val, unref(colorVal))
...
$prefix-cls: '#{$namespace}-color-radio-picker'; // v-color-radio-picker
