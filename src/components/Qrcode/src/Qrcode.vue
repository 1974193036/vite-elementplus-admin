...
const prefixCls = getPrefixCls('qrcode') // v-qrcode
...
const getOriginWidth = async (content: string, options: QRCodeRenderersOptions) => {
  ...
  // console.log(_canvas) // <canvas width="116" height="116" style="width: 116px; height: 116px"></canvas>
  ...
  <div v-loading="loading" :class="[prefixCls, 'relative inline-block']" :style="wrapStyle">
    ...
    >
      <div class="absolute top-[50%] left-[50%] font-bold">
        <Icon icon="ep:refresh-right" :size="30" :color="`var(--${namespace}-color-primary)`" />
...
$prefix-cls: '#{$namespace}-qrcode'; // v-qrcode
